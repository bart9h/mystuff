...
"hi Identifier term=underline	cterm=bold			ctermfg=Cyan guifg=Yellow
...
hi StatusLine    ctermbg=Gray      ctermfg=DarkBlue  guibg=Gray      guifg=DarkBlue
hi StatusLineNC  ctermbg=DarkBlue  ctermfg=Gray      guibg=DarkBlue  guifg=Gray

hi Cursor        ctermfg=None  ctermbg=DarkGray
hi CursorLine    term=None ctermfg=none ctermbg=235 guibg=#303030
hi CursorColumn  ctermfg=None  ctermbg=None cterm=reverse
hi LineNr cterm=none ctermbg=236 ctermfg=none ctermfg=DarkGray guifg=DarkRed
hi NonText cterm=none ctermbg=236 ctermfg=DarkGray guifg=DarkGray

hi Folded ctermbg=234 ctermfg=23 guifg=Yellow guibg=#303000
